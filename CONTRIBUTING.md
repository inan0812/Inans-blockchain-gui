...
This repo includes the code for the Inan GUI in electron/react and TypeScript.

It is an input to the [Inans-blockchain](https://github.com/inan0812/Inans-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [Inanvdf repo](https://github.com/inan0812/Inanvdf) (in c/c++), and a proof of space implementation that it imports from the [Inanpos repo](https://github.com/inan0812/Inanpos). BLS signatures are imported from the [bls-signatures repo](https://github.com/inan0812/bls-signatures) as blspy. There is an additional dependency on the [Inanbip158 repo](https://github.com/inan0812/Inanbip158).
For major platforms, binary and source wheels are shipped to PyPI from each dependent repo and then Inans-blockchain can pip install those from PyPI or they can be prepackaged as is done for the Windows and MacOS installer. On unsupported platforms, pip will fall back to the source distributions to be compiled locally.

If you want to learn more about this project, read the [wiki](https://github.com/inan0812/Inans-blockchain/wiki), or check out the [green paper](https://www.Inan.net/assets/InanGreenPaper.pdf).
...
Contact any of the team members on [Keybase](https://keybase.io/team/Inan_network.public), which we use as the main communication method and you can comment on any Trello card.
